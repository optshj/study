...
export function GrassGraph() {
        ...
        for (let i = 0; ; i++) {
            ...
            if (date.getMonth() !== currentMonth) {
                ...
                monthLabels.push({
                    ...
                    colStart: Math.floor(days.length / 7) + 1
                })
            }
        }
    ...
    return (
        <div className="flex w-full flex-col items-center justify-center gap-4 px-4 py-10">
            ...
            <div className="border-border-gray text-text-primary flex w-full flex-col items-start rounded-xl border p-6">
                ...
                <div className="flex gap-2">
                    <div className="mt-0.5text-text-secondary flex flex-col justify-around gap-1 text-xs">
                        ...
                        <span className="h-4">월</span>
                        <span className="h-4">화</span>
                        <span className="h-4">수</span>
                        <span className="h-4">목</span>
                        <span className="h-4">금</span>
