...
import { Dialog, DialogClose, DialogContent, DialogHeader, DialogTitle, DialogTrigger, ToggleGroupButton } from '@/shared/ui'
...
export function AiButton() {
    ...
    return (
        <Dialog>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>연습문제생성하기</DialogTitle>
                    ...
                    <div className="mt-4 flex w-full items-center justify-center gap-4">
                        <DialogClose asChild>
                            <button
                                className={`bg-emphasis flex-1 rounded-xl py-3 text-white ${isActive ? 'opacity-100' : 'bg-bg-primary cursor-not-allowed'}`}
                                disabled={!isActive}
                            >
                                문제 생성하기
                            </button>
